...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/AeroMapSDK_iOS"
  ...
  # Or just: s.author    = "韩冰个人"
  # s.authors            = { "韩冰个人" => "540945962@qq.com" }
  # s.social_media_url   = "http://twitter.com/韩冰个人"
  ...
  s.source       = { :git => "http://EXAMPLE/AeroMapSDK_iOS.git", :tag => "#{s.version}" }
